...
```
    ...
    Info: Working in directory /Users/izzy/R/bimm143_1/Class 14
...
The pathway for hsa04142 hase the lowest p-value so it is the most
significant. The most significant pathways seem to do not match the KEGG
results. This could be due to differences in methodology and criteria
for data values.
